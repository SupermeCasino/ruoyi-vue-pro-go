...
func InitApp() (*gin.Engine, error) {
	...
	appProductSpuHandler := product3.NewAppProductSpuHandler(productSpuService, productPropertyService, productBrowseHistoryService, memberUserService, memberLevelService)
	...
	appMemberSignInConfigHandler := member2.NewAppMemberSignInConfigHandler(memberSignInConfigService)
