...
func InitApp() (*gin.Engine, error) {
	...
	smsCodeService := service.NewSmsCodeService(query, redisClient)
	...
	tradePriceService := trade.NewTradePriceService(productSkuService, productSpuService, couponUserService, rewardActivityService, memberUserService, memberLevelService)
	tradeOrderUpdateService := trade.NewTradeOrderUpdateService(productSkuService, cartService, tradePriceService, memberAddressService, couponUserService)
	...
	tradeOrderHandler := trade3.NewTradeOrderHandler(tradeOrderUpdateService, tradeOrderQueryService)
	...
	payOrderService := pay.NewPayOrderService(query, payAppService, payChannelService, payClientFactory)
	...
	payNotifyService := pay.NewPayNotifyService(query, zapLogger)
