...
func InitApp() (*gin.Engine, error) {
	...
	tradePriceService := trade.NewTradePriceService(productSkuService, productSpuService, couponUserService, rewardActivityService, memberUserService, memberLevelService, deliveryExpressTemplateService, memberAddressService, memberConfigService)
