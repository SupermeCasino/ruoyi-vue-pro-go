...
func newSystemConfig(db *gorm.DB, opts ...gen.DOOption) systemConfig {
	...
	_systemConfig.Type = field.NewInt32(tableName, "type")
	_systemConfig.Visible = field.NewField(tableName, "visible")
	_systemConfig.Remark = field.NewString(tableName, "remark")
	_systemConfig.Creator = field.NewString(tableName, "creator")
	_systemConfig.Updater = field.NewString(tableName, "updater")
	_systemConfig.CreatedAt = field.NewTime(tableName, "create_time")
	_systemConfig.UpdatedAt = field.NewTime(tableName, "update_time")
	_systemConfig.Deleted = field.NewField(tableName, "deleted")
