...
func newSystemDictType(db *gorm.DB, opts ...gen.DOOption) systemDictType {
	...
	_systemDictType.CreatedAt = field.NewTime(tableName, "create_time")
	_systemDictType.UpdatedAt = field.NewTime(tableName, "update_time")
	_systemDictType.Deleted = field.NewField(tableName, "deleted")
...
func (s systemDictType) Columns(cols ...field.Expr) gen.Columns {
	return s.systemDictTypeDo.Columns(cols...)
}
