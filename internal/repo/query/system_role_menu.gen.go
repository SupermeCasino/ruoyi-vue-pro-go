...
func newSystemRoleMenu(db *gorm.DB, opts ...gen.DOOption) systemRoleMenu {
	...
	_systemRoleMenu.CreatedAt = field.NewTime(tableName, "create_time")
	_systemRoleMenu.UpdatedAt = field.NewTime(tableName, "update_time")
	_systemRoleMenu.Deleted = field.NewField(tableName, "deleted")
	_systemRoleMenu.TenantID = field.NewInt64(tableName, "tenant_id")
