...
func newSystemMenu(db *gorm.DB, opts ...gen.DOOption) systemMenu {
	...
	_systemMenu.CreatedAt = field.NewTime(tableName, "create_time")
	_systemMenu.UpdatedAt = field.NewTime(tableName, "update_time")
	_systemMenu.Deleted = field.NewField(tableName, "deleted")
...
type systemMenu struct {
	...
	Status        field.Int32
	Visible       field.Field
	KeepAlive     field.Field
	AlwaysShow    field.Field
