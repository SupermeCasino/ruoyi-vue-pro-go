...
func newSystemRole(db *gorm.DB, opts ...gen.DOOption) systemRole {
	...
	_systemRole.DataScopeDeptIds = field.NewField(tableName, "data_scope_dept_ids")
	...
	_systemRole.CreatedAt = field.NewTime(tableName, "create_time")
	_systemRole.UpdatedAt = field.NewTime(tableName, "update_time")
	_systemRole.Deleted = field.NewField(tableName, "deleted")
	_systemRole.TenantID = field.NewInt64(tableName, "tenant_id")
...
func (s *systemRole) updateTableName(table string) *systemRole {
	...
	s.DataScopeDeptIds = field.NewField(table, "data_scope_dept_ids")
