...
func newSystemNotice(db *gorm.DB, opts ...gen.DOOption) systemNotice {
	...
	_systemNotice.ID = field.NewInt64(tableName, "id")
	_systemNotice.Title = field.NewString(tableName, "title")
	_systemNotice.Type = field.NewInt32(tableName, "type")
	_systemNotice.Content = field.NewString(tableName, "content")
	_systemNotice.Status = field.NewInt32(tableName, "status")
	_systemNotice.Creator = field.NewString(tableName, "creator")
	_systemNotice.Updater = field.NewString(tableName, "updater")
	_systemNotice.CreatedAt = field.NewTime(tableName, "create_time")
	_systemNotice.UpdatedAt = field.NewTime(tableName, "update_time")
	_systemNotice.Deleted = field.NewField(tableName, "deleted")
	_systemNotice.TenantID = field.NewInt64(tableName, "tenant_id")
...
func (s *systemNotice) WithContext(ctx context.Context) ISystemNoticeDo {
	return s.systemNoticeDo.WithContext(ctx)
}

func (s systemNotice) TableName() string { return s.systemNoticeDo.TableName() }

func (s systemNotice) Alias() string { return s.systemNoticeDo.Alias() }

func (s systemNotice) Columns(cols ...field.Expr) gen.Columns {
	return s.systemNoticeDo.Columns(cols...)
}
