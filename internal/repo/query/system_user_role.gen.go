...
func newSystemUserRole(db *gorm.DB, opts ...gen.DOOption) systemUserRole {
	...
	_systemUserRole.CreatedAt = field.NewTime(tableName, "create_time")
	_systemUserRole.UpdatedAt = field.NewTime(tableName, "update_time")
	_systemUserRole.Deleted = field.NewField(tableName, "deleted")
	_systemUserRole.TenantID = field.NewInt64(tableName, "tenant_id")
...
func (s systemUserRole) Columns(cols ...field.Expr) gen.Columns {
	return s.systemUserRoleDo.Columns(cols...)
}
