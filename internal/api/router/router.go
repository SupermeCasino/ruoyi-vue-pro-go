...
func InitRouter(db *gorm.DB, rdb *redis.Client,
	...
	tenantPackageHandler *handler.TenantPackageHandler,
	...
	appMemberSignInConfigHandler *memberHandler.AppMemberSignInConfigHandler,
	...
	RegisterSystemRoutes(r,
		authHandler, userHandler, tenantHandler, tenantPackageHandler, dictHandler, deptHandler,
	...
	RegisterAppRoutes(r,
		...
		appMemberPointRecordHandler, appMemberSignInRecordHandler, appMemberSignInConfigHandler,
