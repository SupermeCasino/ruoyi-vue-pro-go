...
type kefuService struct {
	...
	systemUserSvc *service.UserService
	wsManager     *websocket.Manager
}

func NewKefuService(q *query.Query, memberUserSvc *member.MemberUserService, systemUserSvc *service.UserService, wsManager *websocket.Manager) KefuService {
	return &kefuService{
		q:             q,
