...
type TradeStatisticsRepository interface {
	GetByDateRange(ctx context.Context, beginTime, endTime time.Time) (*dto.TradeStatisticsDTO, error)
	GetByMonthRange(ctx context.Context, beginTime, endTime time.Time) (*dto.TradeStatisticsDTO, error)
	GetListByDateRange(ctx context.Context, beginTime, endTime time.Time) ([]*dto.TradeStatisticsDTO, error)
	Insert(ctx context.Context, stats *dto.TradeStatisticsDTO) error
}
